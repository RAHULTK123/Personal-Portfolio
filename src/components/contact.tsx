        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 relative z-10">
          ...
          >
            ...
            <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="w-full group py-4 rounded-xl bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500 text-white font-bold text-lg hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] transition-all flex items-center justify-center gap-2"
              >
                Send Message
